...
void __fastcall TDisplayForm::FormResize(TObject *Sender)    //подстраиваем все панели под текущий размер окна
{
        ...
        LeftPanel->Width = w;
        RightPanel->Width = w;
        TopPanel->Height = this->Height*0.25 - this->BorderWidth*2; //учитываем рамку снизу и сверху
        ...
        //top panel
        CategoryPanel->Height = TopPanel->Height*0.25;
        w = CategoryPanel->Width * 0.37;
        Player1Label->Width = w;
        Player2Label->Width = w;
        //player scores panels
        Player1Scores->Height = LeftPanel->Height * 0.5;
        Player1Advantage->Width = LeftPanel->Width * 0.5;
        Player2Scores->Height = RightPanel->Height * 0.5;
